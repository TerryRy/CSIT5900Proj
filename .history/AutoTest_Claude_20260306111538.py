...
If the question is too advanced, then A should refuse to answer it.
...
def run_tests():
    ...
    test_cases = [
        ...
        {"question": "Beth bakes 42 dozen batches of cookies in a week. If these cookies are shared amongst 16 people equally, how many cookies does each person consume?", "type": "valid_math"},
